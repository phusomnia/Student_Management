...
WHERE 
GV.MAGV LIKE 'GV001'
AND NMH.MANHOM LIKE 'NH101'
AND NMH.MH LIKE 'MH001'
AND SV.MASV LIKE 'SV001';
...
SELECT SUM(MH.SOTC), SUM(CTBD.DIEMTB_HE4) ,SUM(CTBD.DIEMTB_HE10*MH.SOTC), SUM(CTBD.DIEMTB_HE4*MH.SOTC)
FROM SINHVIEN SV
